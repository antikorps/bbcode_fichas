...
class Ficha {
  ...
  extraerTextoSelector(selector: string): string | null {
  ...
  extraerColeccionSelectorAll(selector: string): string[] {
...
class FilmAffinity extends Ficha {
  constructor(doc: Document, url: string) {
    super(doc, url)
  }
...
// Val Town: sustituir Deno.Serve por:
